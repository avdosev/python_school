...
После всего что ты прочитал встает вопрос, а шо в итоге то. Итог краток будем делать JWT токены, но чтобы не сильно грустить будем как порядочные люди использовать готовые решения благо их много
