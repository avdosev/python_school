...
Как вы видите это программа очень не очевидна и требует как минимум понимая архитектуры эвм так и знание ассемблера. А мы ведь хотели просто посчитать `(a + b - c) / (a * 2)`.

И если вы поняли, что писать так никто не хотел, то вы не первый человек кто сказал "слишком сложно, давай легче".