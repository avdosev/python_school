...
Предположим мы хотим заставить нашу вычислительную машину считать за нас так не любимые многими математику.
...
Надеюсь вы не забыли о том что мы хотели просто посчитать `(a + b - c) / (a * 2)`, где а, б, с - просто какие то числа.

По сути эвм это сложный калькулятор с неудобными кнопками. У эвм есть только один недостаток - ввод данных.

Чтобы вы начали понимать что из себя представляет работа эвм я предлагаю написать собственный калькулятор. Обычно начинающие пишут нечто подобное:
...
Чем плох этот калькулятор? Он слишком простой. Он ограничевает нашу мысль.

Мы можем написать только элеметарные вещи:
~~~
456
+
123
...
Давайте проанализируем то что происходило до этого

Наш калькулятор требовал два числа и оператор в строго опеределенном порядке

~~~
<выражение> := <число> <оператор> <число>
~~~

предлагаю обобщить нашу граматику до более универсальной

~~~
<выражение> := <число> <оператор> <выражение> | <число>
~~~

это позволяет писать нам такие выражения как `2 + 3 - 5`, так и более сложные

ок, но как такое считать, операторов же может теперь быть сколь угодно, спросите вы меня
